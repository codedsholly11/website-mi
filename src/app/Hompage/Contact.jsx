    ...
    <div id='Contact' className='flex flex-col md:flex-row items-center justify-center md:gap-[50px] gap-[80px] px-[30px] w-[100%] h-full'>
        <form onSubmit={fetchApi} className=''>
            <div className='flex flex-col gap-[10px] md:items-start items-center'>
                <h1 className='text-[40px] font-bold text-[#f0394b]'>Contact Me</h1>
                <p className='flex md:text-start text-center w-[90vw] text-lg font-semibold'>I am open to both remote and on-site work opportunities.</p>
            </div>
            <div className='flex flex-col gap-[20px] items-center md:items-start '>
                <div>
                    <h1 className='text-xl font-bold text-gray-800'>Names</h1>
                    <input onChange={(e)=>setName(e.target.value)} name='name' value={name} required  className='md:w-[35vw] w-[90vw] h-[7vh] bg-[gainsboro] px-[20px] rounded-xl outline-none' type="text" placeholder='Full Name'/>
                </div>
                <div>
                    <h1 className='text-xl font-bold text-gray-800'>Email</h1>
                    <input onChange={(e)=>setEmail(e.target.value)} name='email' value={email} required  className=' md:w-[35vw] w-[90vw] h-[7vh] rounded-xl px-[20px] bg-[gainsboro] outline-none' type="text" placeholder='Email Address'/>
                </div>
                <div>
                ...
                <div>
                    <button className='w-[35vw] h-[7vh] bg-[#f0394b] rounded-xl font-bold'>{sending ? "Sending" : "Send"}</button>
                </div>
        ...
        <div>
            <div className='flex md:items-center'>
                <div className='bg-[#f0394b] w-[40%] py-10 px-8'></div>
        ...
        <div className='bg-black text-white md:w-[60vw] w-[90vw] h-[75vh] flex flex-col md:items-start items-start justify-center gap-[40px] px-[25px]'>
                <h1 className='text-[30px]'>Info</h1>
            <div className='flex flex-col gap-[35px] cursor-pointer'>
                ...
                <div className='flex gap-[20px]'>
                   <div className='text-4xl'><FaRegAddressCard /></div>
                    <p className='w-[70%]'>30B, Ibrahim Taiwo Road, Ilorin, Kwara, NG.</p>
                </div>
            </div>
        </div>
        <div className='flex items-center'>
                <div className='bg-[#f0394b] w-[40%] py-6 px-8'>
