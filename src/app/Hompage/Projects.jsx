...
const Projects = () => {
    const car = [
        { photo: '/images/beauty.jpeg', title: 'WISE CHOICE', link: 'https://wisechoice.vercel.app/' },
        { photo: '/images/tree.jpeg', title: 'Fancy Pix', link: 'https://unsplash-rose.vercel.app' },
        { photo: '/images/home.jpeg', title: 'IB Trading Academy', link: 'https://ib-academy.ng' },
    ...
    return (
        <div id='Work' className='flex flex-col items-center pt-10 mb-[30px] justify-center gap-5 '>
            <div>
                <h1 className='text-[40px] font-bold text-[#f0394b]'>My Projects</h1>
            </div>
                    ...
                    <div key={index} className='relative  group overflow-hidden'>
                        ...
                        <div className='absolute inset-0 bg-gray-800 bg-opacity-100 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 flex items-center justify-center'>
                            <div className='text-white text-center'>
                                ...
                                <a href={c.link} target='_parent' rel='noopener noreferrer'>
